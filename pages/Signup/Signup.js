    ...
    return (
        ...
        <h3>Signup Form</h3>
          ...
          <div className={styles.spassword}>
              ...
              <input type="password" placeholder='Enter your password...' {...register("password", {required: true, minLength: 9})}/>
          ...
          <div className={styles.spassword}>
              ...
              <input type="password" placeholder='Type again your password...' {...register("repassword", {required: true, minLength: 9})}/>
